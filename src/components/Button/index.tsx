  ...
  return (
    <ButtonOutlined {...rest} disabled={disabled}>
      <RowBetween>
        ...
        <ArrowRight size={16} color={disabled ? darken(0.6, theme.white) : theme.bg4} strokeWidth={3} />
      </RowBetween>
    </ButtonOutlined>
  )
}

export function ArrowRightButton({ disabled = false, ...rest }: { disabled?: boolean } & ButtonProps) {
  return (
    <ButtonPrimary {...rest} disabled={disabled} $borderRadius="50%">
      <RowBetween>
...
export function IconButton({ disabled = false, children, ...rest }: { disabled?: boolean } & ButtonProps) {
  return (
    <Base {...rest} disabled={disabled} $borderRadius="50%">
      {children}
    </Base>
  )
}
