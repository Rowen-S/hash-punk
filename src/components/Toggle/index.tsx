...
const ToggleElement = styled.span<{ isActive?: boolean; isOnSwitch?: boolean }>`
  ...
  border-radius: 9px;
  background: ${({ theme, isActive, isOnSwitch }) => (isActive ? (isOnSwitch ? theme.primary1 : theme.blue1) : 'none')};
  ...
  :hover {
    ...
    background: ${({ theme, isActive, isOnSwitch }) =>
      isActive ? (isOnSwitch ? darken(0.05, theme.primary1) : darken(0.05, theme.blue1)) : 'none'};
